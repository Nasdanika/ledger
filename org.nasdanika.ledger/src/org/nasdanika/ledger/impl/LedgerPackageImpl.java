...
public class LedgerPackageImpl extends EPackageImpl implements LedgerPackage {
	 ...
	 * @generated
	 */
	public EOperation getИсточникКурсаАктива__ПолучитьКурс__Date_BigDecimal_EList_КурсАктива() {
	...
	public void createPackageContents() {
		...
		createEOperation(источникКурсаАктиваEClass, ИСТОЧНИК_КУРСА_АКТИВА___ПОЛУЧИТЬ_КУРС__DATE_BIGDECIMAL_ELIST_КУРСАКТИВА);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getИсточникКурсаАктива__ПолучитьКурс__Date_BigDecimal_EList_КурсАктива(), this.getКурсАктива(), "получитьКурс", 0, 1, IS_UNIQUE, IS_ORDERED);
