 ...
 * @generated
 */
public interface ТекущийГодRenderer<T extends ТекущийГод> extends ОтчётныйПериодRenderer<T> {
	/**
	 * @generated
	 */
	ТекущийГодRenderer<ТекущийГод> INSTANCE = new ТекущийГодRenderer<ТекущийГод>() {
	};
	...
	default Renderer<CDOTransactionHttpServletRequestContext<LoginPasswordCredentials>, T> chain(
		...
		return new ТекущийГодRenderer<T>() {
	...
	default LinkedList<Class<?>> getResourceBundleClasses(
		...
		ret.add(ТекущийГодRenderer.class);
