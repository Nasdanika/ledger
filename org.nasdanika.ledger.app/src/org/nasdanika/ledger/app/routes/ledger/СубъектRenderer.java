 ...
 * @generated
 */
public interface СубъектRenderer<T extends Субъект> extends ЭлементМоделиRenderer<T> {
	/**
	 * @generated
	 */
	СубъектRenderer<Субъект> INSTANCE = new СубъектRenderer<Субъект>() {
	};
