...
public interface RendererBase<T extends EObject>
	...
	*/
	...
	default org.nasdanika.cdo.web.routes.app.Renderer.TypedElementLocation getTypedElementLocation(
			CDOTransactionHttpServletRequestContext<LoginPasswordCredentials> context, ETypedElement typedElement)
			throws Exception {

		String typedElementLocationAnnotation = getRenderAnnotation(context, typedElement,
				RenderAnnotation.TYPED_ELEMENT_LOCATION);
