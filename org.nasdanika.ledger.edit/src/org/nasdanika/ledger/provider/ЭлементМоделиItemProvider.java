...
/**
 * This is the item provider adapter for a {@link org.nasdanika.ledger.ЭлементМодели} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ЭлементМоделиItemProvider 
	 ...
	 * @generated
	 */
	public ЭлементМоделиItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ЭлементМодели.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ЭлементМодели"));
	}
	...
	public String getText(Object object) {
		String label = ((ЭлементМодели)object).getНаименование();
		return label == null || label.length() == 0 ?
			getString("_UI_ЭлементМодели_type") :
			getString("_UI_ЭлементМодели_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ЭлементМодели.class)) {
			case LedgerPackage.ЭЛЕМЕНТ_МОДЕЛИ__НАИМЕНОВАНИЕ:
			case LedgerPackage.ЭЛЕМЕНТ_МОДЕЛИ__ОПИСАНИЕ:
			case LedgerPackage.ЭЛЕМЕНТ_МОДЕЛИ__ИДЕНТИФИКАТОР:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case LedgerPackage.ЭЛЕМЕНТ_МОДЕЛИ__КОММЕНТАРИИ:
			case LedgerPackage.ЭЛЕМЕНТ_МОДЕЛИ__ИЗОБРАЖЕНИЕ:
